...
public class EntitySchemaHelper {
  ...
  public static StructuredRecord structuredRecordFromEntity(String entityName, Object entity, Schema schema) {
  ...
  public static Schema getEmailSchema() {
    ...
    fields.add(Schema.Field.of("ccFields", Schema.nullableOf(
      Schema.arrayOf(EntitySchemaHelper.getEmailCCFieldSchema()))));
    return Schema.recordOf(UUID.randomUUID().toString().replace("-", ""), fields);
  }
  ...
  public static Schema getFormSchema() {
    ...
    fields.add(Schema.Field.of("id", Schema.nullableOf(Schema.of(Schema.Type.INT))));
    fields.add(Schema.Field.of("knownVisitor", Schema.nullableOf(EntitySchemaHelper.getFormKnownVisitorDTOSchema())));
    ...
    fields.add(Schema.Field.of("status", Schema.nullableOf(Schema.of(Schema.Type.STRING))));
    fields.add(Schema.Field.of("thankYouList", Schema.nullableOf(
      Schema.arrayOf(EntitySchemaHelper.getFormThankYouPageDTOSchema()))));
