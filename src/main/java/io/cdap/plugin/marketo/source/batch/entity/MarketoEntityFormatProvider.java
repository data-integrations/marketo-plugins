 ...
 */
public class MarketoEntityFormatProvider implements InputFormatProvider {
  public static final String PROPERTY_CONFIG_JSON = "cdap.marketo.entity.config";
  private static final Gson gson = new GsonBuilder().create();
  private final Map<String, String> conf;


  MarketoEntityFormatProvider(MarketoEntitySourceConfig config) {
  ...
  public String getInputFormatClassName() {
    return MarketoEntityInputFormat.class.getName();
  }
